<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="OLDModificaClienti.aspx.cs" Inherits="Default2" %>
        ...
        <tr>
            <td colspan="4">
                <asp:GridView ID="griglia" runat="server" OnSelectedIndexChanged="griglia_SelectedIndexChanged" >
                    <Columns>
                        <asp:ButtonField ButtonType="Button" CommandName="Select" HeaderText="Modifica" ShowHeader="True" Text="Seleziona" />
                    </Columns>
                </asp:GridView>
            </td>
        </tr>

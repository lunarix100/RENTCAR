<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="GestisciSpese.aspx.cs" Inherits="Default2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table>
       <tr>
        ...
        <asp:GridView ID="griglia" runat="server" DataKeyNames="codiceSpesa" OnSelectedIndexChanged="griglia_SelectedIndexChanged">
            <Columns>
